...
export class MovieRepository
{
    ...
    constructor() {
        ...
        this.movies = [
            new Movie(1, "Interstellar", "2014", "English", Nolan, "Alors que la Terre se meurt, une équipe d'astronautes franchit un trou de ver apparu près de Saturne et conduisant à une autre galaxie, afin d'explorer un nouveau système stellaire dans l'espoir de trouver une planète habitable et d'y établir une colonie spatiale pour sauver l'humanité.", 10),
            new Movie(2, "Seul sur Mars", "2015", "English", Scott, "En 2035, l'équipage de la mission de la NASA Ares III est à l'œuvre sur le sol de Mars lorsque survient une tempête d'une intensité particulièrement élevée. La fusée qu'ils doivent utiliser pour repartir risque d'être déséquilibrée par le vent et détruite. L'équipage doit absolument quitter Mars avant que l'inclinaison de la fusée dépasse un seuil critique et les empêche de décoller.", 8),
            new Movie(3, "Ad Astra", "2019", "English", Gray, "Sur Terre, dans un futur proche, l'ingénieur et astronaute de la NASA Roy McBride s'occupe de la maintenance d'une antenne de 30 km de hauteur. Celle-ci est détruite lors d'une surcharge électrique d'antimatière venue de Neptune, qui cause des ravages également sur Terre. Ayant échappé à la mort, le major McBride part alors en mission à la recherche de son père, Clifford McBride, disparu seize années auparavant, lors d'une mission de recherche de vie extraterrestre visant à établir une base à proximité de Neptune.", 7)
        ];
